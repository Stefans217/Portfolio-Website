            ...
            <div className="rounded-lg bg-white p-6 shadow-md flex flex-col h-[600px] max-w-4xl mx-auto">
              ...
              <div className="space-y-4 overflow-y-auto flex-grow pr-2">
                {messages.length === 0 ? (
                  ...
                  messages.map((msg) => (
                    <div key={msg.id} className="rounded-md border border-gray-200 p-4 relative group">
                    ...
                    <div key={post.id} className="rounded-md border border-gray-200 p-4 flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className={`px-2 py-0.5 text-xs rounded-full ${post.published ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}`}>
