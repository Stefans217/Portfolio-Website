...
export default function ContactForm() {
    ...
    return (
        <form onSubmit={onSubmit} aria-describedby={`${formId}-desc`} className="mx-auto max-w-xl space-y-5">
            ...
            <button type="submit" disabled={submit.status === "submitting"} className="inline-flex w-full items-center justify-center rounded-md theme-accent px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600 disabled:cursor-not-allowed disabled:opacity-50">
    ...
    return (
        <div>
            ...
            <input
                ...
                className="block w-full rounded-md border border-gray-700 bg-gray-800 px-3 py-2 text-sm text-foreground placeholder-gray-500 outline-none focus:border-gray-600 focus:ring-0"
    ...
    return (
        <div>
            ...
            <textarea
                ...
                aria-invalid={Boolean(error)}
                aria-describedby={describedBy}
                className="block w-full resize-y rounded-md border border-gray-700 bg-gray-800 px-3 py-2 text-sm text-foreground placeholder-gray-500 outline-none focus:border-gray-600 focus:ring-0"
