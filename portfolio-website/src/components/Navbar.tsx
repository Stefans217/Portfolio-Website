      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between p-4 md:p-6">
        ...
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-3">
            ...
            />
            <span className="hidden sm:inline-block font-semibold text-lg text-white drop-shadow-sm">
              Stefan Spataro
            </span>
          </Link>
        </div>
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link
            href="/"
            className="text-sm font-medium text-gray-200 hover:text-[#c29a62]"
          >
            Home & About
          </Link>
          <Link
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-3">
            <a
              href="https://github.com/Stefans217?tab=repositories"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/stefanspataro-8ba631225/"
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center"
            >
